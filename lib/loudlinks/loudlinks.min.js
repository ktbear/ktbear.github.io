...
var loudlinks = function (e) {
  ...
  function i() {
    var t, r = e.getElementsByClassName("loud-link-hover"), s = e.getElementsByClassName("loud-link-click"),
      a = r.length, u = s.length;
    for (t = 0; a > t; t++) n(r[t]);
    for (t = 0; u > t; t++) o(s[t]);
    return i
  }
  ...
  if (s.log = s.log || function () {
  }, s.error = s.error || s.log, !e.createElement("audio").canPlayType) return s.error("Oh man 😩! \nYour browser doesn't support audio awesomeness."), function () {
  };
  s.log("Audio works like a charm 👍");
  var a = e.createElement("audio"), u = e.createElement("source"), d = e.createElement("source"), l = !1,
    c = /{{type}}/gi, g = "sounds/mp3/", p = "sounds/ogg/";
